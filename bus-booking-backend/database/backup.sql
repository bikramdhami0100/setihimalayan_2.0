...
(1, 1, NOW(), NOW(), 'departed'),
(1, 2, DATE_ADD(NOW(), INTERVAL 45 MINUTE), DATE_ADD(NOW(), INTERVAL 50 MINUTE), 'pending'),
(1, 3, DATE_ADD(NOW(), INTERVAL 3 HOUR), DATE_ADD(NOW(), INTERVAL 3 HOUR + INTERVAL 20 MINUTE), 'pending'),
(1, 4, DATE_ADD(NOW(), INTERVAL 4 HOUR), DATE_ADD(NOW(), INTERVAL 4 HOUR + INTERVAL 5 MINUTE), 'pending'),
(1, 5, DATE_ADD(NOW(), INTERVAL 6 HOUR + INTERVAL 30 MINUTE), NULL, 'pending');
...
(2, 12, 'BK2011', '["A5","A6"]', 2400.00, 'confirmed', 'esewa', 'TXN011', DATE_ADD(NOW(), INTERVAL 10 MINUTE), NOW(), NULL, NULL, NULL, NULL, '{"passengers":[{"name":"Bikram Thapa","age":30,"gender":"M"}]}', NULL, TRUE, NOW(), 'esewa', 'paid', 2400.00, 0.00, 'Bikram Thapa', '9800000011'),
(2, 13, 'BK2012', '["B4","B5"]', 2400.00, 'pending_payment', 'khalti', NULL, DATE_ADD(NOW(), INTERVAL 15 MINUTE), NULL, NULL, NULL, NULL, NULL, '{"passengers":[{"name":"Sunita Rai","age":27,"gender":"F"}]}', NULL, FALSE, NULL, 'khalti', 'unpaid', 2400.00, 0.00, 'Sunita Rai', '9800000012'),
(2, 14, 'BK2013', '["C4"]', 1000.00, 'confirmed', 'connectips', 'TXN013', DATE_ADD(NOW(), INTERVAL 5 MINUTE), NOW(), NULL, NULL, NULL, NULL, '{"passengers":[{"name":"Krishna Pandey","age":40,"gender":"M"}]}', NULL, TRUE, NOW(), 'connectips', 'paid', 1000.00, 0.00, 'Krishna Pandey', '9800000013'),
(2, 15, 'BK2014', '["F4","F5"]', 1800.00, 'confirmed', 'esewa', 'TXN014', DATE_ADD(NOW(), INTERVAL 10 MINUTE), NOW(), NULL, NULL, NULL, NULL, '{"passengers":[{"name":"Maya Gurung","age":33,"gender":"F"}]}', NULL, TRUE, NOW(), 'esewa', 'paid', 1800.00, 0.00, 'Maya Gurung', '9800000014');
